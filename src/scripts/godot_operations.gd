...
## Script attachment is intentionally not supported by the hardened runtime.
func attach_script(_params):
    printerr("attach_script is disabled in the hardened runtime")
    quit(1)
